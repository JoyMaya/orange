...
namespace RedDragon {
    ...
    //% blockId=RedDragon_Music block="Music|%index"
    //% weight=98
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=RedDragon_Servo block="Servo(180°)|num %num|value %value"
    //% weight=97
    //% blockGap=10
    ...
    //% blockId=RedDragon_Servo2 block="Servo(270°)|num %num|value %value"
    //% weight=96
    //% blockGap=10
    ...
    //% blockId=RedDragon_Servo3 block="Servo(360°)|num %num|pos %pos|value %value"
    //% weight=96
    //% blockGap=10
    ...
    //% blockId=RedDragon_StepperDegree block="Stepper Motor(28BYJ-48) |%index|degree %degree"
    //% weight=90
    ...
    //% blockId=RedDragon_StepperTurn block="Stepper Motor(28BYJ-48) |%index|turn %turn|circle"
    //% weight=89
    ...
    //% blockId=RedDragon_StepperDual block="Dual Stepper Motor(Degree) |M1 %degree1| M2 %degree2"
    //% weight=88
